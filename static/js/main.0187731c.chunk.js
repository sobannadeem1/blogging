(this.webpackJsonpclient=this.webpackJsonpclient||[]).push([[0],{112:function(e,t,a){"use strict";a.r(t);var c=a(0),n=a.n(c),s=a(30),r=a.n(s),o=(a(89),a(168)),i=a(12),l=a(15),j=a(1);const d=Object(c.createContext)(null);var b=e=>{let{children:t}=e;const[a,n]=Object(c.useState)({name:"",username:""});return Object(j.jsx)(d.Provider,{value:{account:a,setAccount:n},children:t})},h=a(4),x=a(165),p=a(167);const u=Object(h.a)(x.a)`
    background: #FFFFFF;
    color: black;
`,O=Object(h.a)(p.a)`
...
`,oe={title:"",description:"",picture:"",username:"",categories:"",createdDate:new Date};var ie=()=>{const e=Object(i.h)(),t=Object(i.g)(),[a,n]=Object(c.useState)(oe),[s,r]=Object(c.useState)(""),{account:o}=Object(c.useContext)(d),l=a.picture?a.picture:"https://images.unsplash.com/photo-1543128639-4cb7e6eeef1b?ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8bGFwdG9wJTIwc2V0dXB8ZW58MHx8MHx8&ixlib=rb-1.2.1&w=1000&q=80";Object(c.useEffect)((()=>{var e;(async()=>{if(s){const e=new FormData;e.append("name",s.name),e.append("file",s);const t=await _.uploadFile(e);a.picture=t.data}})(),a.categories=(null===(e=t.search)||void 0===e?void 0:e.split("=")[1])||"All",a.username=o.username}),[s]);const b=e=>{n({...a,[e.target.name]:e.target.value})};return Object(j.jsxs)(ae,{children:[Object(j.jsx)(ce,{src:l,alt:"post"}),Object(j.jsxs)(ne,{children:[Object(j.jsx)("label",{htmlFor:"fileInput",children:Object(j.jsx)(te.a,{fontSize:"large",color:"action"})}),Object(j.jsx)("input",{type:"file",id:"fileInput",style:{display:"none"},onChange:e=>r(e.target.files[0])}),Object(j.jsx)(se,{onChange:e=>b(e),name:"title",placeholder:"Title"}),Object(j.jsx)(E.a,{onClick:()=>(async()=>{await _.createPost(a),e("/")})(),variant:"contained",color:"primary",children:"Publish"})]}),Object(j.jsx)(re,{rowsMin:5,placeholder:"Tell your story...",name:"description",onChange:e=>b(e)})]})},le=a(156),je=a(155);const de=Object(h.a)(o.a)`
    margin-top: 30px;
    background: #F5F5F5;
    padding: 10px;
`,be=Object(h.a)(o.a)`
...
`,pe=Object(h.a)(je.a)`
    margin-left: auto;
`;var ue=e=>{let{comment:t,setToggle:a}=e;const{account:n}=Object(c.useContext)(d);return Object(j.jsxs)(de,{children:[Object(j.jsxs)(be,{children:[Object(j.jsx)(he,{children:t.name}),Object(j.jsx)(xe,{children:new Date(t.date).toDateString()}),t.name===n.username&&Object(j.jsx)(pe,{onClick:()=>(async()=>{await _.deleteComment(t._id),a((e=>!e))})()})]}),Object(j.jsx)(f.a,{children:t.comments})]})};const Oe=Object(h.a)(o.a)`
    margin-top: 100px;
    display: flex;
...
`,Ie={title:"",description:"",picture:"",username:"codeforinterview",categories:"Tech",createdDate:new Date};var ze=()=>{const e=Object(i.h)(),[t,a]=Object(c.useState)(Ie),[n,s]=Object(c.useState)(""),[r,o]=Object(c.useState)(""),{id:l}=Object(i.i)();Object(c.useEffect)((()=>{(async()=>{let e=await _.getPostById(l);e.isSuccess&&a(e.data)})()}),[]),Object(c.useEffect)((()=>{(async()=>{if(n){const e=new FormData;e.append("name",n.name),e.append("file",n);const a=await _.uploadFile(e);a.isSuccess&&(t.picture=a.data,o(a.data))}})()}),[n]);const d=e=>{a({...t,[e.target.name]:e.target.value})};return Object(j.jsxs)(Ce,{children:[Object(j.jsx)(Pe,{src:t.picture||"https://images.unsplash.com/photo-1543128639-4cb7e6eeef1b?ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8bGFwdG9wJTIwc2V0dXB8ZW58MHx8MHx8&ixlib=rb-1.2.1&w=1000&q=80",alt:"post"}),Object(j.jsxs)(Ae,{children:[Object(j.jsx)("label",{htmlFor:"fileInput",children:Object(j.jsx)(te.a,{fontSize:"large",color:"action"})}),Object(j.jsx)("input",{type:"file",id:"fileInput",style:{display:"none"},onChange:e=>s(e.target.files[0])}),Object(j.jsx)(Me,{onChange:e=>d(e),value:t.title,name:"title",placeholder:"Title"}),Object(j.jsx)(E.a,{onClick:()=>(async()=>{await _.updatePost(t),e(`/details/${l}`)})(),variant:"contained",color:"primary",children:"Update"})]}),Object(j.jsx)(De,{rowsMin:5,placeholder:"Tell your story...",name:"description",onChange:e=>d(e),value:t.description})]})},Be=a(175),Re=a(157),qe=a(158),Le=a(159);const Ge=Object(h.a)(o.a)`
...
`,tt=Object(h.a)(f.a)`
    ...
    margin-top: 10px;
    font-weight: 600;
`,at={username:"",password:""},ct={name:"",username:"",password:""};var nt=e=>{let{isUserAuthenticated:t}=e;const[a,n]=Object(c.useState)(at),[s,r]=Object(c.useState)(ct),[l,b]=Object(c.useState)(""),[h,x]=Object(c.useState)("login"),p=Object(i.h)(),{setAccount:u}=Object(c.useContext)(d);Object(c.useEffect)((()=>{b(!1)}),[a]);const O=e=>{n({...a,[e.target.name]:e.target.value})},m=e=>{r({...s,[e.target.name]:e.target.value})},g=()=>{x("signup"===h?"login":"signup")};return Object(j.jsx)(Ze,{children:Object(j.jsxs)(o.a,{children:[Object(j.jsx)(Ve,{src:"https://www.sesta.it/wp-content/uploads/2021/03/logo-blog-sesta-trasparente.png",alt:"blog"}),"login"===h?Object(j.jsxs)(Xe,{children:[Object(j.jsx)($e.a,{variant:"standard",value:a.username,onChange:e=>O(e),name:"username",label:"Enter Username"}),Object(j.jsx)($e.a,{variant:"standard",value:a.password,onChange:e=>O(e),name:"password",label:"Enter Password"}),l&&Object(j.jsx)(tt,{children:l}),Object(j.jsx)(Ke,{variant:"contained",onClick:()=>(async()=>{let e=await _.userLogin(a);e.isSuccess?(b(""),sessionStorage.setItem("accessToken",`Bearer ${e.data.accessToken}`),sessionStorage.setItem("refreshToken",`Bearer ${e.data.refreshToken}`),u({name:e.data.name,username:e.data.username}),t(!0),n(at),p("/")):b("Something went wrong! please try again later")})(),children:"Login"}),Object(j.jsx)(et,{style:{textAlign:"center"},children:"OR"}),Object(j.jsx)(Qe,{onClick:()=>g(),style:{marginBottom:50},children:"Create an account"})]}):Object(j.jsxs)(Xe,{children:[Object(j.jsx)($e.a,{variant:"standard",onChange:e=>m(e),name:"name",label:"Enter Name"}),Object(j.jsx)($e.a,{variant:"standard",onChange:e=>m(e),name:"username",label:"Enter Username"}),Object(j.jsx)($e.a,{variant:"standard",onChange:e=>m(e),name:"password",label:"Enter Password"}),Object(j.jsx)(Qe,{onClick:()=>(async()=>{(await _.userSignup(s)).isSuccess?(b(""),r(ct),x("login")):b("Something went wrong! please try again later")})(),children:"Signup"}),Object(j.jsx)(et,{style:{textAlign:"center"},children:"OR"}),Object(j.jsx)(Ke,{variant:"contained",onClick:()=>g(),children:"Already have an account"})]})]})})};const st=e=>{let{isAuthenticated:t,...a}=e;const c=sessionStorage.getItem("accessToken");return t&&c?Object(j.jsxs)(j.Fragment,{children:[Object(j.jsx)(m,{}),Object(j.jsx)(i.b,{})]}):Object(j.jsx)(i.a,{replace:!0,to:"/account"})};var rt=function(){const[e,t]=Object(c.useState)(!1);return Object(j.jsx)(b,{children:Object(j.jsx)(l.a,{children:Object(j.jsx)(o.a,{style:{marginTop:64},children:Object(j.jsxs)(i.e,{children:[Object(j.jsx)(i.c,{path:"/account",element:Object(j.jsx)(nt,{isUserAuthenticated:t})}),Object(j.jsx)(i.c,{path:"/",element:Object(j.jsx)(st,{isAuthenticated:e}),children:Object(j.jsx)(i.c,{path:"/",element:Object(j.jsx)(X,{})})}),Object(j.jsx)(i.c,{path:"/create",element:Object(j.jsx)(st,{isAuthenticated:e}),children:Object(j.jsx)(i.c,{path:"/create",element:Object(j.jsx)(ie,{})})}),Object(j.jsx)(i.c,{path:"/details/:id",element:Object(j.jsx)(st,{isAuthenticated:e}),children:Object(j.jsx)(i.c,{path:"/details/:id",element:Object(j.jsx)(Te,{})})}),Object(j.jsx)(i.c,{path:"/update/:id",element:Object(j.jsx)(st,{isAuthenticated:e}),children:Object(j.jsx)(i.c,{path:"/update/:id",element:Object(j.jsx)(ze,{})})}),Object(j.jsx)(i.c,{path:"/about",element:Object(j.jsx)(st,{isAuthenticated:e}),children:Object(j.jsx)(i.c,{path:"/about",element:Object(j.jsx)(_e,{})})}),Object(j.jsx)(i.c,{path:"/contact",element:Object(j.jsx)(st,{isAuthenticated:e}),children:Object(j.jsx)(i.c,{path:"/contact",element:Object(j.jsx)(We,{})})})]})})})})};var ot=e=>{e&&e instanceof Function&&a.e(3).then(a.bind(null,176)).then((t=>{let{getCLS:a,getFID:c,getFCP:n,getLCP:s,getTTFB:r}=t;a(e),c(e),n(e),s(e),r(e)}))};r.a.render(Object(j.jsx)(n.a.StrictMode,{children:Object(j.jsx)(rt,{})}),document.getElementById("root")),ot()},89:function(e,t,a){}},[[112,1,2]]]);
//# sourceMappingURL=main.0187731c.chunk.js.map